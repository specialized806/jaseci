...
function jac_app() {
  return App();
            ...
            const globalClientFunctions = ['App', 'LoginForm', 'SignupForm', 'handle_login', 'handle_signup', 'jac_app', 'logout_action'];
...
export { App, LoginForm, SignupForm, handle_login, handle_signup, jac_app, logout_action };
