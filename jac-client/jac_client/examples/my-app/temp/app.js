...
// Client module: app
import { formatMessage, calculateSum, JS_CONSTANT, MessageFormatter } from "./utils";
...
function jac_app() {
  return App();
            ...
            const globalClientFunctions = ['App', 'CustomButton', 'HomeView', 'jac_app'];
    ...
    "jac_app": jac_app
            ...
            const clientFunctions = ['App', 'CustomButton', 'HomeView', 'jac_app'];
            const functionMap = {
    "App": App,
    "CustomButton": CustomButton,
    "HomeView": HomeView,
