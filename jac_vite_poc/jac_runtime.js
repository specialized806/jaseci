...
export function __buildDom(node) {
  if (node === null) {
...
export function __applyProp(element, key, value) {
...
export function __isObject(value) {
  if (value === null) {
    return false;
  }
  return Object.prototype.toString.call(value) === "[object Object]";
}
export function __isFunction(value) {
...
export function __jacHasOwn(obj, key) {
  try {
...
export function __jacEnsureObjectGetPolyfill() {
...
export function __jacGetDocument(scope) {
  try {
...
export function __jacParseJsonObject(text) {
  try {
...
export function __jacBuildOrderedArgs(order, argsDict) {
  let result = [];
  if (!order) {
    return result;
  }
...
export function __jacResolveRenderer(scope) {
...
export function __jacResolveTarget(moduleRecord, registry, name) {
...
export function __jacSafeCallTarget(target, scope, orderedArgs, targetName) {
  try {
...
export function __jacGlobalScope() {
  try {
    return globalThis;
  } catch {}
  try {
...
export function __jacEnsureRegistry() {
...
export function __jacApplyRender(renderer, container, node) {
...
export function __jacHydrateFromDom(defaultModuleName) {
...
export function __jacEnsureHydration(moduleName) {
  __jacEnsureObjectGetPolyfill();
  let registry = __jacEnsureRegistry();
...
export function __jacRegisterClientModule(moduleName, clientFunctions, clientGlobals) {
  __jacEnsureObjectGetPolyfill();
  let scope = __jacGlobalScope();
  let registry = __jacEnsureRegistry();
  let moduleFunctions = {};
