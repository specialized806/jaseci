...
from jaclang.runtimelib.client_bundle import ClientBundle, ClientBundleBuilder, ClientBundleError
...
class ViteClientBundleBuilder(ClientBundleBuilder):
    ...
    def _compile_bundle(
        ...
        jac_init_script = self._generate_jac_init_script(module.__name__, client_exports, client_globals_map)
