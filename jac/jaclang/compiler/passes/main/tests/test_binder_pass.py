...
from jaclang.utils.sym_table_test_helpers import SymTableTestMixin
...
class BinderPassTests( SymTableTestMixin):
    ...
    def test_glob_sym_build(self) -> None:
        ...
        mod_targ = JacProgram().build(self.fixture_abs_path("symbol_binding_test.jac"))
    ...
    def test_symbol_table_structure(self) -> None:
        ...
        self.assertIn("symbol_binding_test", str(sym_table))

        # Verify expected number of symbols in main table
        main_symbols = ["aa", "n", "M1", "z", "Y", "ccc", "bb"]
